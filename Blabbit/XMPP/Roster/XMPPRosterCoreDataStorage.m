...
- (void)saveAndPostNotification
{
    [self scheduleBlock:^{
        [self save];
        // post notification indicating core data cleanup just happened.
        dispatch_async(dispatch_get_main_queue(), ^{
            [[NSNotificationCenter defaultCenter] postNotificationName:kBBTRosterUpdateNotification object:self];
        });
    }];
}
