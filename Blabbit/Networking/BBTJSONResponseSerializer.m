...
NSString * const BBTJSONResponseSerializerKey = @"BBTJSONResponseSerializerKey";


@implementation BBTJSONResponseSerializer
    ...
    if (*error) {
		...
		if (data == nil) {
            ...
            if (JSONResponseObject) {
                [userInfo setObject:JSONResponseObject forKey:BBTJSONResponseSerializerKey];
            }
		}
