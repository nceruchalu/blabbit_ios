//
//  MessagesCoreDataCollectionViewController.h
//  Blabbit
//
...
/**
 * The `MessagesCoreDataCollectionViewController` class is an abstract class
 *   that represents a view controller whose content consists of a
 *   `JSQMessagesCollectionView` and `JSQMessagesInputToolbar` and is specialized
 *   to display a messaging interface.
 *
 ...
 */
@interface MessagesCoreDataCollectionViewController : JSQMessagesViewController <NSFetchedResultsControllerDelegate, UITextViewDelegate>
