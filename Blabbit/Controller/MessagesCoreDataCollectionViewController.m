//
//  MessagesCoreDataCollectionViewController.m
//  Blabbit
//
...
@interface MessagesCoreDataCollectionViewController ()
...
@implementation MessagesCoreDataCollectionViewController

#pragma mark - BELOW CODE IS SIMPLY COPY-PASTE FROM CoreDataCollectionViewController.
#pragma mark SO MAKE CHANGES IN THE IMPLEMENTATION OF THAT FILE AND COPY-PASTE BACK IN HERE
#pragma mark Be sure to:
#pragma mark * Comment out/remove `collectionView:cellForItemAtIndexPath:`
#pragma mark * Call `scrollToBottomAnimated:` in completion handler of `performBatchUpdates:`
...
#pragma mark - END OF COPY-PASTE FROM CoreDataCollectionViewController
